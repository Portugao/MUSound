...
<div style="margin-left: 80px">
    <div class="z-formrow">
        {formlabel for='mUSoundObjectType' __text='Object type'}
            {musoundObjectTypeSelector assign='allObjectTypes'}
            {formdropdownlist id='mUSoundObjectType' dataField='objectType' group='data' mandatory=true items=$allObjectTypes}
    ...
    <div{* class="z-formrow"*}>
        ...
        {musoundItemSelector id='id' group='data' objectType=$objectType}
    </div>
