...
/**
 * The musoundActionUrl modifier creates the URL for a given action.
 *
 ...
 */
function smarty_modifier_musoundActionUrl($urlType, $urlFunc, $urlArguments)
{
    return DataUtil::formatForDisplay(ModUtil::url('MUSound', $urlType, $urlFunc, $urlArguments));
}
