...
/**
 * The musoundFormFrame plugin adds styling <div> elements and a validation summary.
 *
 ...
 */
function smarty_block_musoundFormFrame($params, $content, $view)
{
    ...
    $result .= $view->registerBlock('MUSound_Form_Plugin_FormFrame', $params, $content);
