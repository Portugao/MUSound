...
/**
 * The musoundObjectState modifier displays the name of a given object's workflow state.
 * Examples:
 *    {$item.workflowState|musoundObjectState}       {* with visual feedback *}
 *    {$item.workflowState|musoundObjectState:false} {* no ui feedback *}
 *
 ...
 */
function smarty_modifier_musoundObjectState($state = 'initial', $uiFeedback = true)
{
