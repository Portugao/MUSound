...
<div class="musound-album musound-view">
    ...
    {include file='album/view_quickNav.tpl' all=$all own=$own}{* see template file for available options *}
    ...
    {/if}
        <table class="z-datatable">
            ...
            <tr>
                ...
                <th id="hWorkflowState" scope="col" class="z-left">
                    {sortlink __linktext='State' currentsort=$sort modname='MUSound' type=$lct func='view' sort='workflowState' sortdir=$sdir all=$all own=$own catidMain=$catIdListMainString collection=$collection workflowState=$workflowState searchterm=$searchterm pageSize=$pageSize ot='album'}
                </th>
                {/if}                
        ...
        {if !isset($showAllEntries) || $showAllEntries ne 1}
            {pager rowcount=$pager.numitems limit=$pager.itemsperpage display='page' modname='MUSound' type=$lct func='view' ot='album' lct=$lct}
        {/if}
    {if $lct eq 'admin'}
            <fieldset>
