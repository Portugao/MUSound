...
{if $lct ne 'admin'}
    ...
    {checkpermission component='MUSound:Album:' instance='::' level='ACCESS_COMMENT' assign='hasEditPermission'}
{/if}
{if !isset($nolink)}
...
{foreach name='relLoop' item='item' from=$items}
    {if $hasAdminPermission || $item.workflowState eq 'approved' || ($item.workflowState eq 'defered' && $hasEditPermission && isset($uid) && $item.createdUserId eq $uid)}
    <li>
{strip}
{if !$nolink}
