...
{form enctype='multipart/form-data' cssClass='z-form'}
    ...
    {include file='user/album/include_selectEditOne.tpl' group='track' alias='album' aliasReverse='track' mandatory=false idPrefix='musoundTrack_Album' linkingItem=$track displayMode='dropdown' allowEditing=true}
    {if $mode ne 'create'}
        {include file='user/include_standardfields_edit.tpl' obj=$track}
    {/if}
