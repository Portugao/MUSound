{* purpose of this template: tracks rss feed in user area *}
...
{foreach item='track' from=$items}
    <item>
        ...
        <link>{modurl modname='MUSound' type='user' func='display' ot='track' id=$track.id fqurl='1'}</link>
        <guid>{modurl modname='MUSound' type='user' func='display' ot='track' id=$track.id fqurl='1'}</guid>
