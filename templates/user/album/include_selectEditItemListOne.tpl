{* purpose of this template: inclusion template for display of related album in user area *}
...
<li id="{$idPrefixItem}">
    ...
    <a id="{$idPrefixItem}Edit" href="{modurl modname='MUSound' type='user' func='edit' ot='album' id=$item.id forcelongurl=true}">{$editImage}</a>
