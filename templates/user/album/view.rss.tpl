{* purpose of this template: albums rss feed in user area *}
...
{foreach item='album' from=$items}
    <item>
        ...
        <link>{modurl modname='MUSound' type='user' func='display' ot='album' id=$album.id fqurl='1'}</link>
        <guid>{modurl modname='MUSound' type='user' func='display' ot='album' id=$album.id fqurl='1'}</guid>
