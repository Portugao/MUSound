{* purpose of this template: inclusion template for display of related collection *}
...
<li id="{$idPrefixItem}">
    ...
    <a id="{$idPrefixItem}Edit" href="{modurl modname='MUSound' type=$lct func='edit' ot='collection'  id=$item.id forcelongurl=true}">{$editImage}</a>
