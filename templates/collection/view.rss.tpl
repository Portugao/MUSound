...
{foreach item='collection' from=$items}
    <item>
        ...
        <link>{modurl modname='MUSound' type=$lct func='display' ot='collection'  id=$collection.id fqurl=true}</link>
        <guid>{modurl modname='MUSound' type=$lct func='display' ot='collection'  id=$collection.id fqurl=true}</guid>
