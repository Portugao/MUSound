...
<div class="musound-collection musound-view">
    ...
    {if $canBeCreated}
        {checkpermissionblock component='MUSound:Collection:' instance='::' level='ACCESS_EDIT'}
            ...
            <a href="{modurl modname='MUSound' type=$lct func='edit' ot='collection'}" title="{$createTitle}" class="z-icon-es-add">{$createTitle}</a>
    ...
    {if isset($showAllEntries) && $showAllEntries eq 1}
        ...
        <a href="{modurl modname='MUSound' type=$lct func='view' ot='collection'}" title="{$linkTitle}" class="z-icon-es-view">{$linkTitle}</a>
    ...
    {/if}
        ...
        {if !isset($showAllEntries) || $showAllEntries ne 1}
            {pager rowcount=$pager.numitems limit=$pager.itemsperpage display='page' modname='MUSound' type='collection' func='view' lct=$lct}
        {/if}
    {if $lct eq 'admin'}
            <fieldset>
