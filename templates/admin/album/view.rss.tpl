...
{foreach item='album' from=$items}
    <item>
        ...
        <link>{modurl modname='MUSound' type='admin' func='display' ot='album' id=$album.id fqurl='1'}</link>
        <guid>{modurl modname='MUSound' type='admin' func='display' ot='album' id=$album.id fqurl='1'}</guid>
