...
<div class="musound-album musound-delete">
    ...
    <form class="z-form" action="{modurl modname='MUSound' type='admin' func='delete' ot='album' id=$album.id}" method="post">
        <div>
            ...
            <fieldset>
                ...
                <div class="z-buttons z-formbuttons">
                    ...
                    <a href="{modurl modname='MUSound' type='admin' func='view' ot='album'}">{icon type='cancel' size='small' __alt='Cancel' __title='Cancel'} {gt text='Cancel'}</a>
                </div>
            </fieldset>
