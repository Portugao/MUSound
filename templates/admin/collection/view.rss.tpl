...
{foreach item='collection' from=$items}
    <item>
        ...
        <link>{modurl modname='MUSound' type='admin' func='display' ot='collection' id=$collection.id fqurl='1'}</link>
        <guid>{modurl modname='MUSound' type='admin' func='display' ot='collection' id=$collection.id fqurl='1'}</guid>
