                    ...
                    <div id="musoundItemContainer">
                        ...
                        {foreach item='album' from=$items}
                            <li>
                                ...
                                <a href="#" onclick="mUSound.finder.selectItem({$itemId})" onkeypress="mUSound.finder.selectItem({$itemId})">{$album->getTitleFromDisplayPattern()}</a>
                                <input type="hidden" id="url{$itemId}" value="{modurl modname='MUSound' type='user' func='display' ot='album'  id=$album.id fqurl=true}" />
                                <input type="hidden" id="title{$itemId}" value="{$album->getTitleFromDisplayPattern()|replace:"\"":""}" />
                                <input type="hidden" id="desc{$itemId}" value="{capture assign='description'}{if $album.description ne ''}{$album.description}{/if}
