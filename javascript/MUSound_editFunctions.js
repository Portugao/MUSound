 ...
 */
function mUMUSoundResetUploadField(fieldName)
{
    if (null != $(fieldName)) {
 ...
 */
function mUMUSoundInitUploadField(fieldName)
{
    ...
    if (null != $('reset' + fieldNameCapitalised + 'Val')) {
        $('reset' + fieldNameCapitalised + 'Val').observe('click', function (evt) {
            evt.preventDefault();
            mUMUSoundResetUploadField(fieldName);
 ...
 */
function mUMUSoundResetDateField(fieldName)
{
    if (null != $(fieldName)) {
        $(fieldName).value = '';
    }
 ...
 */
function mUMUSoundInitDateField(fieldName)
{
    var fieldNameCapitalised;
    ...
    if (null != $('reset' + fieldNameCapitalised + 'Val')) {
        $('reset' + fieldNameCapitalised + 'Val').observe('click', function (evt) {
            evt.preventDefault();
            mUMUSoundResetDateField(fieldName);
        }).removeClassName('z-hide').setStyle({ display: 'block' });
    }
}
