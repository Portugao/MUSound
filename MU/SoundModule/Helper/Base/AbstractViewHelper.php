...
abstract class AbstractViewHelper
{
    ...
    public function getViewTemplate($type, $func, $isAdmin = false)
    {
        ...
        $template = '@MUSoundModule/' . ucfirst($type) . '/' . ($isAdmin ? 'Admin/' : '') . $func;
    ...
    {
        $extensions = [];
        $hasAdminAccess = $this->permissionApi->hasPermission('MUSoundModule:' . ucfirst($type) . ':', '::', ACCESS_ADMIN);
        if ($func == 'view') {
            if ($hasAdminAccess) {
    ...
    protected function processPdf(array $templateParameters = [], $template)
    {
        ...
        $output = $this->twig->render('@MUSoundModule/includePdfHeader.html.twig') . $output . '</body></html>';
