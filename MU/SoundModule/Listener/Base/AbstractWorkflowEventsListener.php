...
use MU\SoundModule\Helper\NotificationHelper;
...
abstract class AbstractWorkflowEventsListener implements EventSubscriberInterface
{
    ...
    public function onGuard(GuardEvent $event)
    {
        ...
        $hasApproval = in_array($objectType, ['album']);
        ...
        if (!$this->permissionApi->hasPermission('MUSoundModule:' . ucfirst($objectType) . ':', $entity->getKey() . '::', $permissionLevel)) {
    ...
    public function onEnter(Event $event)
    {
        ...
        if (in_array($entity->get_objectType(), ['album'])) {
