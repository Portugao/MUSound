...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from sound app';
     *     $event->getRequest()->attributes->set('MUSoundModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('MUSoundModule_test');`
     *     now `$testMessage` should be: `'Hello from sound app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('sound App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
