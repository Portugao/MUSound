...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function contentGetTypes(\Zikula_Event $event)
    {
        ...
        $types->add('MUSoundModule_ContentType_Item');
        
        // plugin for showing a list of multiple items
        $types->add('MUSoundModule_ContentType_ItemList');
    }
     ...
     * MUSoundModule will use this to add a javascript helper to add custom items.
     *
     * You can access general data available in the event.
     *
     * The event name:
    ...
    public function getEditorHelpers(\Zikula_Event $event)
    {
        ...
        $helpers->add(
            [
                ...
                'type'   => 'javascript',
                'path'   => 'modules/MU/SoundModule/Resources/public/js/MUSoundModule.Finder.js'
            ]
        );
    }
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'musoundmodule',
                'path' => 'modules/MU/SoundModule/Resources/scribite/TinyMce/musoundmodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'musoundmodule',
                'path' => 'modules/MU/SoundModule/Resources/scribite/CKEditor/musoundmodule/',
                'file' => 'plugin.js',
                'img'  => 'ed_musoundmodule.gif'
            ]
        );
    }
}
