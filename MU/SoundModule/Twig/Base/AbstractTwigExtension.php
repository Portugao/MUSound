...
namespace MU\SoundModule\Twig\Base;
...
use MU\SoundModule\Helper\EntityDisplayHelper;
use MU\SoundModule\Helper\WorkflowHelper;
...
abstract class AbstractTwigExtension extends Twig_Extension
{
    ...
    {
        return [
            new \Twig_SimpleFunction('musoundmodule_moderationObjects', [$this, 'getModerationObjects']),
            new \Twig_SimpleFunction('musoundmodule_objectTypeSelector', [$this, 'getObjectTypeSelector']),
            new \Twig_SimpleFunction('musoundmodule_templateSelector', [$this, 'getTemplateSelector'])
        ];
    }
    ...
    {
        return [
            new \Twig_SimpleFilter('musoundmodule_fileSize', [$this, 'getFileSize'], ['is_safe' => ['html']]),
            new \Twig_SimpleFilter('musoundmodule_listEntry', [$this, 'getListEntry']),
            new \Twig_SimpleFilter('musoundmodule_formattedTitle', [$this, 'getFormattedEntityTitle']),
            new \Twig_SimpleFilter('musoundmodule_objectState', [$this, 'getObjectState'], ['is_safe' => ['html']])
        ];
    }
    
    /**
     * The musoundmodule_objectState filter displays the name of a given object's workflow state.
     * Examples:
     *    {{ item.workflowState|musoundmodule_objectState }}        {# with visual feedback #}
     *    {{ item.workflowState|musoundmodule_objectState(false) }} {# no ui feedback #}
     *
    ...
    /**
     * The musoundmodule_fileSize filter displays the size of a given file in a readable way.
     * Example:
     *     {{ 12345|musoundmodule_fileSize }}
     *
    ...
    /**
     * The musoundmodule_listEntry filter displays the name
     * or names for a given list item.
     * Example:
     *     {{ entity.listField|musoundmodule_listEntry('entityName', 'fieldName') }}
     *
    ...
    /**
     * The musoundmodule_moderationObjects function determines the amount of unapproved objects.
    ...
    /**
     * The musoundmodule_objectTypeSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    /**
     * The musoundmodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    /**
     * The musoundmodule_formattedTitle filter outputs a formatted title for a given entity.
     * Example:
     *     {{ myPost|musoundmodule_formattedTitle }}
     *
