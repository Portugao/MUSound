...
namespace MU\SoundModule\Form\Type\QuickNavigation\Base;
...
/**
 * Track quick navigation form type base class.
 */
abstract class AbstractTrackQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    * @param EntityDisplayHelper $entityDisplayHelper EntityDisplayHelper service instance
    ...
    {
        $listEntries = $this->listHelper->getEntries('track', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
        ...
        $builder
            ->add('sort', ChoiceType::class, [
                ...
                'choices' =>             [
                    ...
                    $this->__('Upload track') => 'uploadTrack',
                    $this->__('Upload zip') => 'uploadZip',
    ...
    {
        return 'musoundmodule_trackquicknav';
    }
}
