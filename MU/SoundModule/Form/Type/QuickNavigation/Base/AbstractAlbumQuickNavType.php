    ...
    * @param EntityDisplayHelper $entityDisplayHelper EntityDisplayHelper service instance
    ...
    public function addCategoriesField(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('categories', CategoriesType::class, [
            ...
            'entityCategoryClass' => 'MU\SoundModule\Entity\\' . ucfirst($objectType) . 'CategoryEntity'
        ]);
    }
        ...
        $builder
            ->add('sort', ChoiceType::class, [
                ...
                'choices' =>             [
                    ...
                    $this->__('Upload cover') => 'uploadCover',
                    $this->__('Published date') => 'publishedDate',
                    $this->__('Published text') => 'publishedText',
    ...
    {
        return 'musoundmodule_albumquicknav';
    }
}
