...
abstract class AbstractAlbumType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->addEventListener(FormEvents::PRE_SET_DATA, function (FormEvent $event) {
            ...
            foreach (['uploadCover'] as $uploadFieldName) {
    ...
    public function addEntityFields(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('author', TextType::class, [
            ...
            'attr' => [
                'maxlength' => 255,
                'class' => '',
                'title' => $this->__('Enter the author of the album')
            ],
            'required' => false,
        ]);
        
        $builder->add('uploadCover', UploadType::class, [
            'label' => $this->__('Upload cover') . ':',
            'attr' => [
                'class' => ' validate-upload',
                'title' => $this->__('Enter the upload cover of the album')
            ],
        ...
        $builder->add('publishedDate', DateTimeType::class, [
            'label' => $this->__('Published date') . ':',
            'empty_data' => '',
            'attr' => [
                'class' => '',
                'title' => $this->__('Enter the published date of the album')
            ],
            'required' => false,
            'empty_data' => null,
            'with_seconds' => true,
        ...
        $builder->add('publishedText', TextType::class, [
            'label' => $this->__('Published text') . ':',
            'empty_data' => '',
            'attr' => [
                'maxlength' => 255,
                'class' => '',
                'title' => $this->__('Enter the published text of the album')
            ],
            'required' => false,
        ]);
    }
    ...
    public function addCategoriesField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('categories', CategoriesType::class, [
            ...
            'required' => false,
            'multiple' => false,
            'module' => 'MUSoundModule',
            'entity' => 'AlbumEntity',
            'entityCategoryClass' => 'MU\SoundModule\Entity\AlbumCategoryEntity'
        ]);
    }
    ...
    public function addIncomingRelationshipFields(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('collection', 'Symfony\Bridge\Doctrine\Form\Type\EntityType', [
            'class' => 'MUSoundModule:CollectionEntity',
    ...
    public function addOutgoingRelationshipFields(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('track', 'Symfony\Bridge\Doctrine\Form\Type\EntityType', [
            'class' => 'MUSoundModule:TrackEntity',
            'choice_label' => $choiceLabelClosure,
            'by_reference' => false,
            'multiple' => true,
            'expanded' => false,
            ...
            'label' => $this->__('Track'),
            'attr' => [
                'title' => $this->__('Choose the track')
            ]
        ]);
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver
            ->setDefaults([
                ...
                'data_class' => 'MU\SoundModule\Entity\AlbumEntity',
                'empty_data' => function (FormInterface $form) {
                    return $this->entityFactory->createAlbum();
                },
                'error_mapping' => [
                    'uploadCover' => 'uploadCover.uploadCover',
                ],
                'mode' => 'create',
                'is_moderator' => false,
                'is_creator' => false,
