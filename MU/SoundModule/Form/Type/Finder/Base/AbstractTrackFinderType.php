...
namespace MU\SoundModule\Form\Type\Finder\Base;
...
/**
 * Track finder form type base class.
 */
abstract class AbstractTrackFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the track') => 1,
                $this->__('Absolute url to the track') => 2,
                $this->__('ID of track') => 3
            ],
    ...
    {
        return 'musoundmodule_trackfinder';
    }
