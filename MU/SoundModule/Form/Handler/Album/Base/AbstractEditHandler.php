...
namespace MU\SoundModule\Form\Handler\Album\Base;

use MU\SoundModule\Form\Handler\Common\EditHandler;
use MU\SoundModule\Form\Type\AlbumType;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUSoundModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'album', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];
    ...
    protected function getRedirectUrl($args)
    {
        ...
        switch ($this->returnTo) {
            ...
            case 'adminViewCollections':
                return $this->router->generate('musoundmodule_collection_' . $routeArea . 'view');
            case 'userOwnViewCollections':
            case 'adminOwnViewCollections':
                return $this->router->generate('musoundmodule_collection_' . $routeArea . 'view', ['own' => 1]);
            case 'userDisplayCollection':
            case 'adminDisplayCollection':
                if (!empty($this->relationPresets['collection'])) {
                    return $this->router->generate('musoundmodule_collection_' . $routeArea . 'display',  ['id' => $this->relationPresets['collection']]);
                }
