...
namespace MU\SoundModule\Form\Handler\Collection\Base;

use MU\SoundModule\Form\Handler\Common\EditHandler;
use MU\SoundModule\Form\Type\CollectionType;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUSoundModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'collection', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];
