...
namespace MU\SoundModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            $jsAssetBag->add($assetHelper->resolve('@MUSoundModule:js/MUSoundModule.js'));
            $jsAssetBag->add($assetHelper->resolve('@MUSoundModule:js/MUSoundModule.ItemSelector.js'));
        ...
        if (!$permissionApi->hasPermission('MUSoundModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }

        $categorisableObjectTypes = ['album'];
        $catIds = [];
        ...
        $view = Zikula_View::getInstance('MUSoundModule', false);
    ...
    public function decode(Zikula_Form_View $view)
    {
        ...
        $this->objectType = $request->request->get('MUSoundModule_objecttype', 'collection');
