...
namespace MU\SoundModule\Block\Base;

use Zikula\BlocksModule\AbstractBlockHandler;
use Zikula\Core\AbstractBundle;
use MU\SoundModule\Helper\FeatureActivationHelper;
use MU\SoundModule\Block\Form\Type\ItemListBlockType;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('MUSoundModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        // create query
        $orderBy = $this->get('mu_sound_module.model_helper')->resolveSortParameter($objectType, $properties['sorting']);
        ...
        if (in_array($objectType, $this->categorisableObjectTypes)) {
            if ($featureActivationHelper->isEnabled(FeatureActivationHelper::CATEGORIES, $properties['objectType'])) {
                $categoryHelper = $this->get('mu_sound_module.category_helper');
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('MUSoundModule items');
        }
        ...
        $templateParameters = $this->get('mu_sound_module.controller_helper')->addTemplateParameters($properties['objectType'], $templateParameters, 'block', []);
    ...
    public function getFormOptions()
    {
        ...
        return [
            ...
            'category_helper' => $this->get('mu_sound_module.category_helper'),
            'feature_activation_helper' => $this->get('mu_sound_module.feature_activation_helper')
        ];
    }
    ...
    {
        return '@MUSoundModule/Block/itemlist_modify.html.twig';
    }
