 ...
 */
abstract class AbstractCollectionFilterHooksSubscriber implements HookSubscriberInterface
{
    /**
    ...
    /**
     * CollectionFilterHooksSubscriber constructor.
     *
    ...
    {
        return [
            FilterHooksCategory::TYPE_FILTER => 'musoundmodule.filter_hooks.collections.filter'
        ];
    }
}
