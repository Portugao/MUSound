 ...
 */
abstract class MUSound_Base_AbstractUploadHandler
{
    /**
    ...
    {
        $this->allowedObjectTypes = array('album', 'track');
        ...
        $this->allowedFileSizes = array('album' => array('uploadCover' => 102400), 'track' => array('uploadTrack' => 1024000, 'uploadZip' => 1024000));
    }
    ...
    public function performFileUpload($objectType, $fileData, $fieldName)
    {
        ...
        if ($isImage) {
            ...
            if (\ModUtil::getVar('MUSound', 'enableShrinkingFor' . $fieldSuffix, false) == true) {
                // resize to allowed maximum size
                $thumbManager = $serviceManager->get('systemplugin.imagine.manager');
                $maxWidth = \ModUtil::getVar('MUSound', 'shrinkWidth' . $fieldSuffix, 800);
                $maxHeight = \ModUtil::getVar('MUSound', 'shrinkHeight' . $fieldSuffix, 600);
