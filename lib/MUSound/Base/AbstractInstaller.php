 ...
 */
abstract class MUSound_Base_AbstractInstaller extends Zikula_AbstractInstaller
{
    /**
    ...
    public function install()
    {
        ...
        $this->setVar('pageSizeCollection', 0);
        $this->setVar('pagesizeAlbum', 0);
        $this->setVar('pagesizeTrack', 0);
        $this->setVar('maxSizeCover', 0);
        $this->setVar('maxSizeTrack', 0);
        $this->setVar('maxSizeZip', 0);
        ...
        include_once 'modules/MUSound/lib/MUSound/Api/Base/AbstractCategory.php';
