 ...
 */
abstract class MUSound_Controller_Base_AbstractExternal extends Zikula_AbstractController
{
    /**
    ...
    public function finder()
    {
        ...
        $this->throwForbiddenUnless(SecurityUtil::checkPermission('MUSound:' . ucfirst($objectType) . ':', '::', ACCESS_COMMENT), LogUtil::getErrorMsgPermission());
