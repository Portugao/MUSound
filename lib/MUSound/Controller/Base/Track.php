 ...
 */
class MUSound_Controller_Base_Track extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function delete()
    {
        ...
        if ($confirmation && $deleteAllowed) {
            ...
            if (!$validators->hasErrors()) {
                ...
                // Let any hooks know that we have created, updated or deleted the track
    ...
    public function handleInlineRedirect()
    {
        ...
        $this->view->display('track/inlineRedirectHandler.tpl');
