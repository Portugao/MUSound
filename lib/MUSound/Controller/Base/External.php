 ...
 */
class MUSound_Controller_Base_External extends Zikula_AbstractController
{
    /**
    ...
    public function finder()
    {
        ...
        $this->throwForbiddenUnless(SecurityUtil::checkPermission('MUSound:' . ucwords($objectType) . ':', '::', ACCESS_COMMENT), LogUtil::getErrorMsgPermission());
        ...
        $categoryIds = ModUtil::apiFunc('MUSound', 'category', 'retrieveCategoriesFromRequest', array('ot' => $objectType, 'source' => 'GET'));
