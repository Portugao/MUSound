 ...
 */
class MUSound_Controller_Collection extends MUSound_Controller_Base_AbstractCollection
{
    /**
    ...
    public function view()
    {
        ...
        $order = $this->getVar('orderOfCollections');
        ...
        if ($showAllEntries == 1) {
            ...
            $resultsPerPage = ModUtil::getVar($this->name, 'pageSizeCollection', 10);
        ...
        $currentUrlObject = new Zikula_ModUrl($this->name, 'collection', 'view', ZLanguage::getLanguageCode(), $currentUrlArgs);
