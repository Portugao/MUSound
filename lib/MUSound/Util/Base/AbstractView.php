 ...
 */
abstract class MUSound_Util_Base_AbstractView extends Zikula_AbstractBase
{
    /**
    ...
    {
        $extensions = array();
        $hasAdminAccess = SecurityUtil::checkPermission('MUSound:' . ucfirst($type) . ':', '::', ACCESS_ADMIN);
        if ($func == 'view') {
            if ($hasAdminAccess) {
