 ...
 */
class MUSound_Listener_Base_ThirdParty
{
    /**
    ...
    public static function contentGetTypes(Zikula_Event $event)
    {
        ...
        $types->add('MUSound_ContentType_Item');
        
        // plugin for showing a list of multiple items
        $types->add('MUSound_ContentType_ItemList');
    }
    ...
    public static function getEditorHelpers(Zikula_Event $event)
    {
        ...
        $helpers->add(
            array('module' => 'MUSound',
                  'type'   => 'javascript',
                  'path'   => 'modules/MUSound/javascript/MUSound_finder.js')
        );
    }
    ...
    public static function getTinyMcePlugins(Zikula_Event $event)
    {
        ...
        $plugins->add(
            array('name' => 'musound',
                  'path' => 'modules/MUSound/docs/scribite/plugins/TinyMce/vendor/tinymce/plugins/musound/editor_plugin.js'
            )
        );
    }
    ...
    public static function getCKEditorPlugins(Zikula_Event $event)
    {
        ...
        $plugins->add(
            array('name' => 'musound',
                  'path' => 'modules/MUSound/docs/scribite/plugins/CKEditor/vendor/ckeditor/plugins/musound/',
                  'file' => 'plugin.js',
                  'img'  => 'ed_musound.gif'
            )
        );
