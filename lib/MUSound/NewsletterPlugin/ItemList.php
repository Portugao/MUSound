 ...
 */
class MUSound_NewsletterPlugin_ItemList extends Newsletter_AbstractPlugin
{
    /**
    ...
    {
        return $this->__('Latest MUSound items');
    }
    ...
    {
        return $this->__('List of collections and other MUSound items');
    }
    ...
    {
        return $this->__('This plugin shows a list of collections and other items of the MUSound module.');
    }
    ...
    public function getParameters()
    {
        ...
        if (ModUtil::available($this->modname) && ModUtil::loadApi($this->modname)) {
            $objectTypes['album'] = array('name' => $this->__('Albums'));
            $objectTypes['track'] = array('name' => $this->__('Tracks'));
