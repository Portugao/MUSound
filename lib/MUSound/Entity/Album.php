 ...
 */
class MUSound_Entity_Album extends MUSound_Entity_Base_Album
{
     ...
     * @ORM\PrePersist
     * @ORM\PreUpdate
     * @see MUSound_Entity_Album::performPreSaveCallback()
     * @return void.
     */
     ...
     * @ORM\PostPersist
     * @ORM\PostUpdate
     * @see MUSound_Entity_Album::performPostSaveCallback()
     * @return void.
     */
