 ...
 * @abstract
 */
abstract class MUSound_Entity_Base_Collection extends Zikula_EntityAccess
{
    /**
     ...
     *
     * @ORM\OneToMany(targetEntity="MUSound_Entity_Album", mappedBy="collection")
     ...
     *
     * @see MUSound_Entity_Collection::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see MUSound_Entity_Collection::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
