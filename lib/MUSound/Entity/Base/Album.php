 ...
 * @abstract
 */
abstract class MUSound_Entity_Base_Album extends Zikula_EntityAccess
{
    /**
    ...
    /**
     * @var MUSound_Entity_Validator_Album The validator for this entity.
     */
     ...
     */
    protected $uploadCoverMeta = array();
     ...
     *
     * @var string $uploadCoverFullPath.
     */
    protected $uploadCoverFullPath = '';
    
    /**
     * Full upload cover path as url.
     *
     * @var string $uploadCoverFullPathUrl.
     */
    protected $uploadCoverFullPathUrl = '';
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="MUSound_Entity_AlbumCategory", 
     ...
     * Get _validator.
     *
     * @return MUSound_Entity_Validator_Album
     */
     ...
     * Set _validator.
     *
     * @param MUSound_Entity_Validator_Album $_validator.
     *
     * @return void
     */
    public function set_validator(MUSound_Entity_Validator_Album $_validator = null)
    {
    ...
    {
        if ($uploadCover != $this->uploadCover) {
            $this->uploadCover = $uploadCover;
        }
    }
    
    /**
     * Get upload cover full path.
     *
     * @return string
     */
    public function getUploadCoverFullPath()
    {
        return $this->uploadCoverFullPath;
    }
    
    /**
     * Set upload cover full path.
     *
     * @param string $uploadCoverFullPath.
     *
     * @return void
     */
    public function setUploadCoverFullPath($uploadCoverFullPath)
    {
        if ($uploadCoverFullPath != $this->uploadCoverFullPath) {
            $this->uploadCoverFullPath = $uploadCoverFullPath;
        }
    }
    
    /**
     * Get upload cover full path url.
     *
     * @return string
     */
    public function getUploadCoverFullPathUrl()
    {
        return $this->uploadCoverFullPathUrl;
    }
    
    /**
     * Set upload cover full path url.
     *
     * @param string $uploadCoverFullPathUrl.
     *
     * @return void
     */
    public function setUploadCoverFullPathUrl($uploadCoverFullPathUrl)
    {
        if ($uploadCoverFullPathUrl != $this->uploadCoverFullPathUrl) {
            $this->uploadCoverFullPathUrl = $uploadCoverFullPathUrl;
        }
    }
    
    /**
     * Get upload cover meta.
     *
     * @return array
     */
    ...
    /**
     * Set upload cover meta.
     *
     * @param array $uploadCoverMeta.
     *
     * @return void
     */
    public function setUploadCoverMeta($uploadCoverMeta = Array())
    {
        if ($uploadCoverMeta != $this->uploadCoverMeta) {
    ...
    {
        if ($publishedDate != $this->publishedDate) {
    ...
    {
        if ($publishedText != $this->publishedText) {
     ...
     * Set track.
     *
     * @param MUSound_Entity_Track[] $track.
     *
     * @return void
     */
    ...
    /**
     * Adds an instance of MUSound_Entity_Track to the list of track.
     *
     * @param MUSound_Entity_Track $track The instance to be added to the collection.
     *
     * @return void
     */
    public function addTrack(MUSound_Entity_Track $track)
    {
    ...
    /**
     * Removes an instance of MUSound_Entity_Track from the list of track.
     *
     * @param MUSound_Entity_Track $track The instance to be removed from the collection.
     *
     * @return void
     */
    public function removeTrack(MUSound_Entity_Track $track)
    {
     ...
     *
     * @return MUSound_Entity_Validator_Album The validator for this entity.
     */
    public function initValidator()
    {
        ...
        $this->_validator = new MUSound_Entity_Validator_Album($this);
    ...
    public function initWorkflow($forceLoading = false)
    {
        ...
        $idColumn = 'id';
        $workflowHelper = new MUSound_Util_Workflow(ServiceUtil::getManager());
        ...
        if ($currentType == 'admin') {
            ...
            if ($authAdmin || (isset($uid) && isset($this->createdUserId) && $this->createdUserId == $uid)) {
                ...
                $this->_actions[] = array(
                    ...
                    'icon' => 'add',
                    'linkTitle' => __('Create track', $dom),
                    'linkText' => __('Create track', $dom)
                );
            }
        }
        if ($currentType == 'user') {
    ...
    {
        return 'musound.ui_hooks.albums';
    }
     ...
     *
     * @see MUSound_Entity_Album::postLoadCallback()
    ...
    protected function performPostLoadCallback()
    {
        ...
        if (!empty($this['uploadCover'])) {
            try {
                $basePath = $controllerHelper->getFileBaseFolder('album', 'uploadCover');
            } catch (\Exception $e) {
                return LogUtil::registerError($e->getMessage());
            }
        
            $fullPath = $basePath .  $this['uploadCover'];
            $this['uploadCoverFullPath'] = $fullPath;
            $this['uploadCoverFullPathURL'] = System::getBaseUrl() . $fullPath;
        
            // just some backwards compatibility stuff
            /*if (!isset($this['uploadCoverMeta']) || !is_array($this['uploadCoverMeta']) || !count($this['uploadCoverMeta'])) {
                // assign new meta data
                $this['uploadCoverMeta'] = $uploadManager->readMetaDataForFile($this['uploadCover'], $fullPath);
            }*/
        }
        $this->formatTextualField('publishedText', $currentFunc, $usesCsvOutput);
     ...
     *
     * @see MUSound_Entity_Album::prePersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see MUSound_Entity_Album::postPersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see MUSound_Entity_Album::preRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see MUSound_Entity_Album::postRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
    protected function performPostRemoveCallback()
    {
        ...
        $uploadFields = array('uploadCover');
        foreach ($uploadFields as $uploadField) {
            ...
            $uploadManager->deleteUploadFile('album', $this, $uploadField, $objectId);
        }
     ...
     *     - no creation of other entities allowed
     *
     * @see MUSound_Entity_Album::preUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see MUSound_Entity_Album::postUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see MUSound_Entity_Album::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see MUSound_Entity_Album::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
