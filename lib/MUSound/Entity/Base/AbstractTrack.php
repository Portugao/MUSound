 ...
 * @abstract
 */
abstract class MUSound_Entity_Base_AbstractTrack extends Zikula_EntityAccess
{
    /**
     ...
     *
     * @ORM\ManyToOne(targetEntity="MUSound_Entity_Album", inversedBy="track", cascade={"persist"})
     ...
     * @return void
     */
    public function setUploadTrack(string $uploadTrack)
    {
     ...
     * @return void
     */
    public function setUploadZip(string $uploadZip)
    {
            ...
            if (in_array($currentFunc, array('main', 'view'))) {
                $this->_actions[] = array(
                    'url' => array(
                        'type' => 'user',
                        'func' => 'display',
                        'arguments' => array('ot' => 'track', 'id' => $this['id'])
                    ),
                    'icon' => 'preview',
                ...
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    ...
                    $this->_actions[] = array(
                        'url' => array(
                            'type' => 'admin',
                            'func' => 'edit',
                            'arguments' => array('ot' => 'track', 'astemplate' => $this['id'])
                        ),
                        'icon' => 'saveas',
