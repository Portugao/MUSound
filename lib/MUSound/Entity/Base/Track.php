...
abstract class MUSound_Entity_Base_Track extends Zikula_EntityAccess
{
    ...
    {
        if ($uploadTrack != $this->uploadTrack) {
            $this->uploadTrack = $uploadTrack;
        }
    }
    
    /**
     * Get upload track full path.
     *
     * @return string
     */
    ...
    {
        if ($uploadTrackFullPath != $this->uploadTrackFullPath) {
            $this->uploadTrackFullPath = $uploadTrackFullPath;
        }
    }
    
    /**
     * Get upload track full path url.
     *
     * @return string
     */
    ...
    /**
     * Set upload track full path url.
     *
    ...
    {
        if ($uploadTrackFullPathUrl != $this->uploadTrackFullPathUrl) {
            $this->uploadTrackFullPathUrl = $uploadTrackFullPathUrl;
        }
    }
    
    /**
     * Get upload track meta.
     *
     * @return array
     */
    ...
    {
        if ($uploadTrackMeta != $this->uploadTrackMeta) {
    ...
    {
        if ($uploadZip != $this->uploadZip) {
            $this->uploadZip = $uploadZip;
        }
    }
    
    /**
     * Get upload zip full path.
     *
     * @return string
     */
    ...
    {
        if ($uploadZipFullPath != $this->uploadZipFullPath) {
            $this->uploadZipFullPath = $uploadZipFullPath;
        }
    }
    
    /**
     * Get upload zip full path url.
     *
     * @return string
     */
    ...
    {
        if ($uploadZipFullPathUrl != $this->uploadZipFullPathUrl) {
