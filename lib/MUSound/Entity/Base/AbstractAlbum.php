 ...
 * @abstract
 */
abstract class MUSound_Entity_Base_AbstractAlbum extends Zikula_EntityAccess
{
    /**
     ...
     *
     * @ORM\ManyToOne(targetEntity="MUSound_Entity_Collection", inversedBy="album", cascade={"persist"})
     ...
     * @return void
     */
    public function setUploadCover(string $uploadCover)
    {
        $this->uploadCover = $uploadCover;
    }
    
    /**
     * Gets the upload cover full path.
     *
     * @return string
     */
    ...
    /**
     * Sets the upload cover full path.
     *
    ...
    /**
     * Gets the upload cover full path url.
     *
     * @return string
     */
    ...
    /**
     * Sets the upload cover full path url.
     *
    ...
    protected function performPostRemoveCallback()
    {
        ...
        foreach ($uploadFields as $uploadField) {
            ...
            $uploadManager->deleteUploadFile('mUSound', $this, $uploadField, $objectId);
        }
            ...
            if (in_array($currentFunc, array('main', 'view'))) {
                $this->_actions[] = array(
                    'url' => array(
                        'type' => 'user',
                        'func' => 'display',
                        'arguments' => array('ot' => 'album', 'id' => $this['id'])
                    ),
                    'icon' => 'preview',
                ...
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    ...
                    $this->_actions[] = array(
                        'url' => array(
                            'type' => 'admin',
                            'func' => 'edit',
                            'arguments' => array('ot' => 'album', 'astemplate' => $this['id'])
                        ),
                        'icon' => 'saveas',
