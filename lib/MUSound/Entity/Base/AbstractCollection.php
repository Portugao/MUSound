 ...
 * @abstract
 */
abstract class MUSound_Entity_Base_AbstractCollection extends Zikula_EntityAccess
{
    /**
    ...
    /**
     * @var MUSound_Entity_Validator_Collection The validator for this entity
     */
    ...
    /**
     * Bidirectional - One collection [collection] has many album [albums] (INVERSE SIDE).
     *
     * @ORM\OneToMany(targetEntity="MUSound_Entity_Album", mappedBy="collection", cascade={"persist"})
     * @ORM\JoinTable(name="musound_collectionalbum")
     ...
     * Gets the _validator.
     *
     * @return MUSound_Entity_Validator_Collection
     */
     ...
     * Sets the _validator.
     *
     * @param MUSound_Entity_Validator_Collection $_validator
     *
     * @return void
     */
    public function set_validator(MUSound_Entity_Validator_Collection $_validator = null)
    {
    ...
    public function setAlbum($album)
    {
        foreach ($album as $albumSingle) {
            $this->addAlbum($albumSingle);
        }
    }
    
    /**
     * Adds an instance of MUSound_Entity_Album to the list of album.
     *
     * @param MUSound_Entity_Album $album The instance to be added to the collection
     *
     * @return void
     */
    public function addAlbum(MUSound_Entity_Album $album)
    {
        $this->album->add($album);
        $album->setCollection($this);
    }
    
    /**
     * Removes an instance of MUSound_Entity_Album from the list of album.
     *
     * @param MUSound_Entity_Album $album The instance to be removed from the collection
     *
     * @return void
     */
    public function removeAlbum(MUSound_Entity_Album $album)
    {
     ...
     *
     * @see MUSound_Entity_Collection::postLoadCallback()
     ...
     *
     * @see MUSound_Entity_Collection::prePersistCallback()
     * @return boolean true if completed successfully else false
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see MUSound_Entity_Collection::postPersistCallback()
     * @return boolean true if completed successfully else false
     */
     ...
     *
     * @see MUSound_Entity_Collection::preRemoveCallback()
     * @return boolean true if completed successfully else false
     */
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see MUSound_Entity_Collection::postRemoveCallback()
     * @return boolean true if completed successfully else false
     */
     ...
     *     - no creation of other entities allowed
     *
     * @see MUSound_Entity_Collection::preUpdateCallback()
     * @return boolean true if completed successfully else false
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see MUSound_Entity_Collection::postUpdateCallback()
     * @return boolean true if completed successfully else false
     */
     ...
     *
     * @return MUSound_Entity_Validator_Collection The validator for this entity
     */
    public function initValidator()
    {
        ...
        $this->_validator = new MUSound_Entity_Validator_Collection($this);
    ...
    {
        return 'musound.ui_hooks.collections';
    }
