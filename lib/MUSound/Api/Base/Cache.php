 ...
 */
class MUSound_Api_Base_Cache extends Zikula_AbstractApi
{
    /**
    ...
    public function clearItemCache(array $args = array())
    {
        ...
        $cacheIds[] = 'MUSound/user/main'; // main function
        $cacheIds[] = 'MUSound/user/view/' . $objectType; // view function (list views)
        $cacheIds[] = 'MUSound/user/display/' . $objectType . '|' . $instanceId; // display function (detail views)
