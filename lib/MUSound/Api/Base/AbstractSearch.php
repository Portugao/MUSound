 ...
 */
abstract class MUSound_Api_Base_AbstractSearch extends Zikula_AbstractApi
{
    /**
    ...
    public function options(array $args = array())
    {
        ...
        $searchTypes = array('album', 'track', 'collection');
        foreach ($searchTypes as $searchType) {
            $view->assign('active_' . $searchType, (!isset($args['mUSoundSearchTypes']) || in_array($searchType, $args['mUSoundSearchTypes'])));
        }
    ...
    public function search(array $args = array())
    {
        ...
        $searchTypes = isset($args['objectTypes']) ? (array)$args['objectTypes'] : (array) FormUtil::getPassedValue('mUSoundSearchTypes', array(), 'GETPOST');
    ...
    public function search_check(array $args = array())
    {
        ...
        if ($datarow['extra'] != '') {
            ...
            unset($urlArgs['type']);
            if (in_array($objectType, array('album', 'track', 'collection'))) {
