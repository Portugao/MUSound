 ...
 */
abstract class MUSound_Api_Base_AbstractAdmin extends Zikula_AbstractApi
{
    /**
    ...
    public function getLinks()
    {
        ...
        if (in_array('album', $allowedObjectTypes)
            ...
            $links[] = array(
                'url' => ModUtil::url($this->name, 'admin', 'view', array('ot' => 'album')),
                 'text' => $this->__('Albums'),
        ...
        if (in_array('track', $allowedObjectTypes)
            ...
            $links[] = array(
                'url' => ModUtil::url($this->name, 'admin', 'view', array('ot' => 'track')),
                 'text' => $this->__('Tracks'),
