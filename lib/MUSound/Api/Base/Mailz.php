 ...
 */
class MUSound_Api_Base_Mailz extends Zikula_AbstractApi
{
    /**
    ...
    public function getPlugins(array $args = array())
    {
        ...
        $plugins[] = array(
            'pluginid'      => 1,
            'module'        => 'MUSound',
            'title'         => $this->__('3 newest collections'),
            'description'   => $this->__('A list of the three newest collections.')
        );
        $plugins[] = array(
            'pluginid'      => 2,
            'module'        => 'MUSound',
            'title'         => $this->__('3 random collections'),
            'description'   => $this->__('A list of three random collections.')
        );
        return $plugins;
    }
    ...
    public function getContent(array $args = array())
    {
        ...
        list($entities, $objectCount) = ModUtil::apiFunc('MUSound', 'selection', 'getEntitiesPaginated', $selectionArgs);
    
        $view = Zikula_View::getInstance('MUSound', true);
