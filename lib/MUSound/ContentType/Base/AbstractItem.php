 ...
 */
abstract class MUSound_ContentType_Base_AbstractItem extends Content_AbstractContentType
{
    ...
    public function getTitle()
    {
        ...
        return __('MUSound detail view', $dom);
    }
    ...
    public function getDescription()
    {
        ...
        return __('Display or link a single MUSound object.', $dom);
    }
    ...
    public function display()
    {
        if (null !== $this->id && !empty($this->displayMode)) {
            return ModUtil::func('MUSound', 'external', 'display', $this->getDisplayArguments());
        }
