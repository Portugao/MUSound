 ...
 */
class MUSound_Form_Plugin_Base_RelationSelectorAutoComplete extends MUSound_Form_Plugin_AbstractObjectSelector
{
    /**
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        $createLink = '';
        if ($this->createLink != '') {
            $createLink = '<a id="' . 'SelectorDoNew" href="' . DataUtil::formatForDisplay($this->createLink) . '" title="' . __f('Create new %s', array($entityNameTranslated), $dom) . '" class="z-button musound-inline-button">' . __('Create', $dom) . '</a>';
        }
        ...
        $result = '
            <div class="musound-relation-rightside">'
                ...
                <div id="' . $idPrefix . 'AddFields">
                    ...
                    <div id="' . $idPrefix . 'SelectorChoices" class="musound-autocomplete' . (($this->withImage) ? '-with-image' : '') . '"></div>
