 ...
 */
class MUSound_Form_Plugin_Base_AbstractRelationSelectorAutoComplete extends MUSound_Form_Plugin_AbstractObjectSelector
{
    /**
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        switch ($this->objectType) {
            case 'album':
                $entityNameTranslated = __('album', $dom);
                break;
            case 'track':
                $entityNameTranslated = __('track', $dom);
                break;
            case 'collection':
        ...
        $createLink = '';
        if ($this->createLink != '') {
            $createLink = '<a id="' . $idPrefix . 'SelectorDoNew" href="' . DataUtil::formatForDisplay($this->createLink) . '" title="' . __f('Create new %s', array($entityNameTranslated), $dom) . '" class="z-button musound-inline-button">' . __('Create', $dom) . '</a>';
        }

        $result = '
            <div class="musound-relation-rightside">'
                . $addLink . '
                <div id="' . $idPrefix . 'AddFields" class="musound-autocomplete' . ($this->withImage ? '-with-image' : '') . '">
                    ...
                    <input type="button" id="' . $idPrefix . 'SelectorDoCancel" name="' . $idPrefix . 'SelectorDoCancel" value="' . __('Cancel', $dom) . '" class="z-button musound-inline-button" />'
                    . $createLink . '
