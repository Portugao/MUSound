 ...
 */
class MUSound_Form_Plugin_Base_AbstractItemSelector extends Zikula_Form_Plugin_TextInput
{
    /**
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if (!SecurityUtil::checkPermission('MUSound:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }
