 ...
 */
class MUSound_Form_Handler_Admin_Base_Config extends Zikula_Form_AbstractHandler
{
    /**
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        // initialise list entries for the 'skin' setting
        
        $modVars['skinItems'] = array(array('value' => 'bluemonday', 'text' => 'Bluemonday'),
        array('value' => 'pinkflag', 'text' => 'Pinkflag')
        );
