...
/**
 * This handler class handles the page events of the Form called by the mUSound_admin_edit() function.
 * It aims on the track object type.
 *
 * More documentation is provided in the parent class.
 */
class MUSound_Form_Handler_Admin_Track_Base_Edit extends MUSound_Form_Handler_Admin_Edit
{
    /**
     * Pre-initialise hook.
     *
    ...
    public function preInitialize()
    {
        ...
        $this->uploadFields = array('uploadTrack' => false, 'uploadZip' => false);
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if ($this->mode == 'create') {
            ...
            if (!$modelHelper->canBeCreated($this->objectType)) {
                LogUtil::registerError($this->__('Sorry, but you can not create the track yet as other items are required which must be created before!'));
        ...
        if (count($this->listFields) > 0) {
            $helper = new MUSound_Util_ListEntries($this->view->getServiceManager());
